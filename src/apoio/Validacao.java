...
public class Validacao {
    ...
    public static boolean validarCPF(String cpf) {
        if ((cpf == null) || (cpf.length() != 11)) { // se o cpf for nulo ou diferente de 11, retorna false 
            return false;
        }
    ...
    // formatação para validação de emails
    // se o campo digitado conter @ está correto e retorna true
    // se não conter @ retorna false   
    ...
    public static boolean validarDecimal(String campo) {
     if(campo.isEmpty()) {
        return false; 
    } else {
        return true;
